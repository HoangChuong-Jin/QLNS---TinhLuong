    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="card card-yellow">
                ...
                <form action="{{route('postphongban')}}" method="POST" style="margin: 10px;">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Mã phòng ban: </label>
                            <input type="text" class="form-control @error('maphongban') is-invalid @enderror" id="exampleInputEmail1" placeholder="Nhập mã phòng ban" name="maphongban" value="{{old('maphongban')}}">
                            @error('maphongban')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên phòng ban" name="tenphongban" value="{{old('tenphongban')}}">
                        </div>
                        <!-- /.form-group -->
                        <button type='submit' class='btn btn-primary' name=''><i class='fa fa-plus'></i> Tạo phòng ban</button>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
                                ...
                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                    ...
                                    @foreach($viewdata as $data)
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                            <td><a href="{{route('suaphongban', ['id'=>$data->id])}}" class="text-orange"><i class="fa fa-edit"></i></a></td>
