...
<!-- Google Font: Source Sans Pro -->
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="{{ asset('resources/adminlte/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet" href="{{ asset('resources/adminlte/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
    <link rel="stylesheet" href="{{ asset('resources/adminlte/plugins/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
    @toastr_css 
